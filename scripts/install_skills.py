#!/usr/bin/env python3
"""Detect AI coding agents on this machine and install the devrig skill.

Discovers tools by config directories and PATH binaries, then copies
skills/devrig/SKILL.md into the correct project and/or global skill paths.
...
SKILL_REL = Path("skills/devrig/SKILL.md")
SKILL_NAME = "devrig"
...
TOOLS: tuple[AgentTool, ...] = (
    AgentTool(
        ...
        home_markers=(".claude",),
        binaries=("claude",),
        project_skill_dir=".claude/skills/devrig",
        global_skill_dir=".claude/skills/devrig",
    ),
    AgentTool(
        id="codex",
        name="OpenAI Codex",
        home_markers=(".codex",),
        binaries=("codex",),
        project_skill_dir=".codex/skills/devrig",
        global_skill_dir=".codex/skills/devrig",
    ),
    AgentTool(
        id="opencode",
        name="OpenCode",
        ...
        binaries=("opencode",),
        project_skill_dir=".opencode/skills/devrig",
        global_skill_dir=".config/opencode/skills/devrig",
    ),
    AgentTool(
        id="cursor",
        name="Cursor",
        ...
        project_skill_dir=".cursor/skills/devrig",
        global_skill_dir=".cursor/skills/devrig",
    ),
    AgentTool(
        id="grok",
        name="Grok / xAI",
        home_markers=(".grok",),
        binaries=("grok",),
        project_skill_dir=".grok/skills/devrig",
        global_skill_dir=".grok/skills/devrig",
    ),
    AgentTool(
        id="agents",
        ...
        home_markers=(".agents",),
        binaries=(),
        project_skill_dir=".agents/skills/devrig",
        global_skill_dir=".agents/skills/devrig",
    ),
    AgentTool(
        id="gemini",
        name="Gemini CLI",
        ...
        binaries=("gemini",),
        project_skill_dir=".agents/skills/devrig",
        global_skill_dir=".gemini/skills/devrig",
        extra_global_skill_dirs=(".agents/skills/devrig",),
    ),
    AgentTool(
        id="windsurf",
        name="Windsurf",
        ...
        binaries=("windsurf",),
        project_skill_dir=".agents/skills/devrig",
        global_skill_dir=".codeium/windsurf/skills/devrig",
        extra_global_skill_dirs=(".agents/skills/devrig",),
    ),
    AgentTool(
        id="continue",
        ...
        binaries=(),
        project_skill_dir=".continue/skills/devrig",
        global_skill_dir=".continue/skills/devrig",
    ),
)
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Detect AI coding agents and install the devrig SKILL.md",
