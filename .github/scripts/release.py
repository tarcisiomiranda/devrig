#!/usr/bin/env python3
"""Validate artifacts and publish a devrig GitHub release."""
...
# Names must match install.sh: BINARY_os_arch (underscores, from uname).
EXPECTED_BINARIES = {
    "devrig_darwin_amd64",
    "devrig_darwin_arm64",
    "devrig_linux_amd64",
...
class GitHubAPI:
    ...
    def _headers(self, content_type: str = "application/json") -> dict[str, str]:
        return {
            ...
            "User-Agent": "devrig-release-script",
...
def collect_and_verify_assets(release_dir: Path) -> list[Path]:
    ...
    binary_paths = {path.name: path for path in release_dir.glob("devrig_*")}
